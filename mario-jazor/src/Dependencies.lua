...
gFrames = {
    ...
    ['keys-and-locks'] = GenerateQuads(gTextures['keys_and_locks'], 16, 16),
    ['keys'] = {},
    ['locks'] = {},
...
for i = 1, #KEYS do
    table.insert(gFrames['keys'], gFrames['keys-and-locks'][i])
    table.insert(gFrames['locks'], gFrames['keys-and-locks'][i + 4])
end
