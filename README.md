...
**Solution**: This is also easy, spawn key and lock as game objects and have them know each other's existence. When key is consumed, remove lock from play with a variable self.inPlay for game object.
...
**Solution**: Extend tileMap width and draw goal column by column
...
**Solution**: When flag is consumed, change game state back to `play`, a new level will be created.
...
## Submission
[![GD50 - Mario Submission](http://img.youtube.com/vi/WYzff3yky-k/0.jpg)](http://www.youtube.com/watch?v=WYzff3yky-k "GD50 - Mario Submission")
